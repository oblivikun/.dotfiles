...
The script
#+BEGIN_SRC mksh :tangle home/.app-launcher-fzf.sh
#!/usr/bin/env mksh
...
#+END_SRC
** StumpWM
+I use https://stumpwm.github.io/ as my window manager *right now*. I ++ ++ ++ recently switched from herbstluftwm.+ Looks like this.
